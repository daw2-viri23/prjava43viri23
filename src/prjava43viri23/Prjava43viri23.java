...
public class Prjava43viri23 extends Frame 
   ...
   public Prjava43viri23 () { 
      ...
      setTitle("prjava43viri23");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43viri23();  // Let the construct do the job 
   } 
